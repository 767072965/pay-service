package com.lxz.pay.controller;

import com.lxz.pay.sdk.AcpService;
import com.lxz.pay.sdk.LogUtil;
import com.lxz.pay.sdk.SDKConfig;
import com.lxz.pay.sdk.SDKConstants;
...
public class UnionController {
    ...
    public String toPay(HttpServletRequest request, HttpServletResponse response){
        ...
        //前台页面传过来的
        String merId = "777290058169054";
        String txnAmt = "22";
        String orderId ="65468126841545";
        ...
        requestData.put("frontUrl", "www.baidu.com");
        ...
        requestData.put("backUrl", "www.baidu.com");
